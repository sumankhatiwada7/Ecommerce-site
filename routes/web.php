     ...
     Route::controller(sellermaincontroller::class)->group(function () {
        ...
        Route::get('/order/history','orderhistory')->name('vendor.order.history');
           ...
           Route::controller(sellerproductcontroller::class)->group(function () {
             ...
             Route::get('/product/{id}/edit','edit')->name('seller.product.edit');
             Route::put('/product/{id}', 'update')->name('seller.product.update');
             Route::delete('/product/{id}', 'delete')->name('seller.product.delete');
          });
           Route::controller(sellerstorecontroller::class)->group(function () {
                ...
                Route::get('/store/{id}/edit', 'edit')->name('seller.store.edit');
                Route::put('/store/{id}', 'update')->name('seller.store.update');
                Route::delete('/store/{id}', 'delete')->name('seller.store.delete');
          });
        });
   });
