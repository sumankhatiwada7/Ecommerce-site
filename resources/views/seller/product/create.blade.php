...
<div class="card">
    ...
    <label for="image" class="fw-bold mb-3">Product Image</label>
    <input type="file" class="form-control mb-3" name="image[]" multiple>
    ...
    <label for="visibility" class="fw-bold mb-3">Visibility</label>
    ...
    <label for="status" class="fw-bold mb-3">Status</label>
